...
static inline void hwpe_cg_enable() { /**(int *)(REDMULE_SUBSYSTEM_REDMULE_CLK_GATE_ADDR) = 1;*/ return; }

static inline void hwpe_cg_disable() { /**(int *)(REDMULE_SUBSYSTEM_REDMULE_CLK_GATE_ADDR) = 0;*/ return; }
