...
#define REDMULE_SUBSYSTEM_REGS_ADDR 0x00200000
#define REDMULE_SUBSYSTEM_RETURN_ADDR REDMULE_SUBSYSTEM_REGS_ADDR + 0x00
#define REDMULE_SUBSYSTEM_EOC_ADDR REDMULE_SUBSYSTEM_REGS_ADDR + 0x04
#define REDMULE_SUBSYSTEM_REDMULE_CLK_GATE_ADDR REDMULE_SUBSYSTEM_REGS_ADDR + 0x08
